	...
	return (
		<div className='flex flex-col gap-4'>
			...
			<div className='text-sm'>
				<TruncateSection allowSeeMore={true}>
					<p className='pb-5'>
					...
					<p className='pb-5'>
						...
						component of a person&apos;s total caloric needs. The daily caloric
						need is the BMR value multiplied by a factor with a value between
						1.2 and 1.9, depending on activity level.
					</p>
					<p className='pb-5'>
